...
# module references:
# DSP_core, convertType_14_32, convertType_14_32, convertType_32_14, convertType_32_14, sync, DAC_core
...
proc create_hier_cell_PS_ZYNQ { parentCell nameHier } {
  ...
  create_bd_pin -dir O -from 31 -to 0 regAddr
  create_bd_pin -dir O -from 31 -to 0 regVal
  create_bd_pin -dir O -from 0 -to 0 regWrtEn
  ...
  connect_bd_net -net PS_ZYNQ_Dout [get_bd_pins regWrtEn] [get_bd_pins xlslice/Dout]
  connect_bd_net -net PS_ZYNQ_gpio_io_o [get_bd_pins regAddr] [get_bd_pins axi_gpio_regAddr/gpio_io_o]
  connect_bd_net -net PS_ZYNQ_gpio_io_o1 [get_bd_pins regVal] [get_bd_pins axi_gpio_regVal/gpio_io_o]
...
proc create_hier_cell_DAC { parentCell nameHier } {
  ...
  set block_cell_name DAC_core
  if { [catch {set DAC_core [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
...
proc create_hier_cell_CLK { parentCell nameHier } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.MMCM_CLKOUT2_PHASE {-330.000} \
...
proc create_root_design { parentCell } {
  ...
  set block_name convertType_14_32
  ...
  set block_name convertType_32_14
  ...
  connect_bd_net -net convertType_14_32_ADC2_dataOut [get_bd_pins DSP_core/adc2] [get_bd_pins convertType_14_32_ADC2/dataOut]
  connect_bd_net -net convertType_32_14_DAC1_dataOut [get_bd_pins DAC/dac_data1] [get_bd_pins convertType_32_14_DAC1/dataOut]
  connect_bd_net -net convertType_32_14_DAC2_dataOut [get_bd_pins DAC/dac_data2] [get_bd_pins convertType_32_14_DAC2/dataOut]
  connect_bd_net -net digital_i_1 [get_bd_ports digital_i] [get_bd_pins sync_digitalIn/dataIn]
  connect_bd_net -net sync_digitalIn_dataOut [get_bd_pins DSP_core/digitalIn] [get_bd_pins sync_digitalIn/dataOut]
