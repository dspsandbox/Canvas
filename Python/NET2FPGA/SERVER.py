...
class SERVER_CLASS: 
    ...
    def __init__(self,settings):
        ...
        self.TCP_IP=settings.SERVER_TCP_IP
        self.TCP_PORT=settings.SERVER_TCP_PORT
    ...
    def getWorkspaceContent(self,pathOutput,filePathConstants):
        ...
        for filePath,fileContent in zip(filePathList,fileContentList):
            ...
            if not os.path.isfile(filePathConstants):
                ...
                f=open(fileName,"wb+")
                f.write("#########################################################################\r\n")
                f.write("# NET2FPGA constants file\r\n")
                f.write("# MIT License")
                f.write("# Copyright (c) 2019 Pau Gomez Kabelka <paugomezkabelka@gmail.com>\r\n")
                f.write("#########################################################################\r\n")
                ...
                f.write("\r\n# Example:\r\n\r\n")
                f.write("# const1Bit[0]=1 \r\n")
                f.write("# const1Bit[1]=0 \r\n")
                f.write("# const1Bit[2]=1 \r\n")
                f.write("# const32Bit[0]=-52 \r\n")
                f.write("# const32Bit[1]=1024 \r\n")
                f.write("# const32Bit[2]=0 \r\n")
                f.close()
        if self.debug:   
            print ("Response/process: %s"%self.process)
