...
filePathNetInput="../Examples/Basic/PulseFaraday/Input/input.net"                        #Path to .net file to be implemented on FPGA
pathOutput="../Examples/Basic/PulseFaraday/Output"                                       #Path to place NET2FPGA output products
filePathBitstream="../Examples/Basic/PulseFaraday/Output/Bitstream/bitstream.bit"        #Path to bitstream.bit file.  
filePathConstants="../Examples/Basic/PulseFaraday/Constants/constants.py"                #Path to constants.py file. If not present an empty file will be created. 
